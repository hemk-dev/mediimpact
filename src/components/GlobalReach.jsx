  ...
  return (
    <section className="py-16 bg-gray-50">
      <div className="container mx-auto px-6 lg:px-20">
        <h2 className="text-3xl font-bold text-[#06643A] mb-6 text-center my-4">Global Reach</h2>
        <div className="flex flex-col items-center gap-8">
          ...
          <p className="text-gray-700 text-lg text-justify leading-relaxed">
            ...
            to Africa, Europe to the Americas, Medi Impact has established a
            ...
            borders. At Medi Impact, our vision extends beyond commerce; we aim
